...
public class FavoriteController {
    ...
    @PostMapping("/toggle")
    public ResponseEntity<?> toggleFavorite(@RequestParam(required = false) String userId,
    ...
    @GetMapping
    public ResponseEntity<List<FavoriteListResponse>> getFavoriteRecipes(@RequestParam(required = false) String userId){
